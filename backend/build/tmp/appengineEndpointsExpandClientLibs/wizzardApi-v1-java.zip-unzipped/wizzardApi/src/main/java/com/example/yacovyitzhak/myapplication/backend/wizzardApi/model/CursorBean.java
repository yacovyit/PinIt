...
package com.example.yacovyitzhak.myapplication.backend.wizzardApi.model;

/**
 * Model definition for CursorBean.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the wizzardApi. For a detailed explanation see:
